...
*   💻 **Hardware Monitoring:** Hooks directly into HWiNFO's C++ shared memory to show your CPU/GPU temps and usage, plus your FPS(With RTSS)!
*   🎯 **Custom Crosshair:** Puts a little red dot right in the center of your screen!
*   🕰️ **System Clock:** Because sometimes you lose track of time and windows minimizes your clock.
*   🚨 **PANIC BUTTON:** Press F12 and your entire screen instantly goes black. YOU'RE WELCOME!
*   📺 **Resolution Independent:** Dynamically scales fonts and UI based on your monitor's resolution. NOT FULLY TESTED but am looking for feedback on resolutions different from 2k.
...
1. **Windows 10/11**: Necessary due to prerequisite DLLs. ^-^
2. **[HWiNFO64](https://www.hwinfo.com/)**: This is REQUIRED if you want hardware and FPS stats! 
   * *Important:* You need to go into HWiNFO settings and enable **Shared Memory Support**. If you don't, GPU/CPU data cannot be read. (Side note: On the free version of HWiNFO, you must reenable this setting every 12 hours. Nothing I can do about that :<)
3. **[RivaTuner Statistics Server (RTSS)](https://www.guru3d.com/files-details/rtss-rivatuner-statistics-server-download.html)**: Technically Optional, but you need this running in the background if you want the FPS counter to work.
